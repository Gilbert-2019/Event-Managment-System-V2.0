 ...
 class VerificationSuccess extends Component {
  ...
  render() {
    ...
    <CodeInput
      ...
      onFulfill={(isValid, code) => this.props.navigation.navigate('LoginScreenAdmin')}
    />
          ...
          <TouchableOpacity onPress={() => this.props.navigation.navigate('SignupScreenAdmin')} >
...
<View style= {styles.paddingTextInput3}>		
      ...
      />
		...
		<View style = {styles.buttonalign}>						
					<TouchableOpacity style = {styles. Buttoncontainer}  onPress={() => this.props.navigation.navigate('LoginScreenAdmin')}>
