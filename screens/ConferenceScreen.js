...
import Quote from'../components/Quotes5';
...
const{width : WIDTH} = Dimensions.get('window')
 ...
 class ConferenceScreen extends Component {
  ...
  render() {
    return (
		...
		<View style = {styles.itemcontainer}>
		<Text style={styles.itemTextcontainer}> Types </Text>
		...
		<Text style={styles.TextInputContainer}></Text>
			...
			<Picker
				...
				<Picker.Item label="-Select-" value="Sport" />
				<Picker.Item label="CSE Conference" value="Conference" />
				<Picker.Item label="Code Conference" value="Conference" />
				<Picker.Item label="Photo Conference" value="Conference" />
				<Picker.Item label="EnglishDay Conference" value="Conference" />
